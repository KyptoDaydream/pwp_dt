...
class Story extends React.Component {
  render () {
    const class_trigger = this.props.triggering_class_secondary !== 'dont_trigger' ? 'onCenter' : 'onLeave';
    return (
      <StoryWrapper
      ...
      >
          ...
          <h3 id={this.props.triggering_class}>
            {this.props.headline}
          </h3>
          <p id={this.props.triggering_class_secondary}>
            {this.props.text}
          </p>
